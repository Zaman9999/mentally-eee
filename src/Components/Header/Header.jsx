      ...
      <div className="wrapper">
        <div className="py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex lg:flex lg:gap-12 md:gap-7 items-center">
              ...
              {navLinks.map(({ path, label, subLinks }) => (
                <div key={label} className="relative group">
                  {path ? (
                    ...
                    <>
                      <button
                        className="text-[#747474] hover:text-black text-base font-medium leading-5 duration-300 flex items-center"
            ...
            <NavLink to="/signup">
              <button className="border-1 border-black rounded text-black py-2 px-6 md:px-4 md:py-1 lg:px-6 lg:py-2 lg:text-base z-10">
                Sign Up
              </button>
            </NavLink>
          </div>
